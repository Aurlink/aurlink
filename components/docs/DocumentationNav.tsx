// components/docs/DocumentationNav.tsx - PRODUCTION READY
'use client'
import { useState } from 'react'
import { Search, Menu, X, BookOpen, Github, Discord, Rocket } from 'lucide-react'

export function DocumentationNav() {
  const [isSearchOpen, setIsSearchOpen] = useState(false)

  return (
    <nav className="fixed top-0 left-0 right-0 z-40 bg-[#0A0F2C]/95 backdrop-blur-xl border-b border-white/10">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-2 px-3 py-1 bg-green-500/20 border border-green-500/30 rounded-full">
              ...
              <span className="text-green-400 text-sm font-medium">Live & Production Ready</span>
            </div>
          </div>
